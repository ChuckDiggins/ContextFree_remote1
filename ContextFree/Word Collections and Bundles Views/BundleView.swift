...
//        var body: some View {
//            VStack{
//                Text("bundle: \(currentBundle.getName())")
//                Text("teacher: \(currentBundle.getTeacher())")
//                Text("Tense count: \(currentBundle.getTenseList().count)")
//                Text("Word collection count: \(currentBundle.getCollectionList().count)")
//                Text("Phrase count: \(currentBundle.getPhraseList().count)")
//            }
//            VStack{
//                VStack{
//                    Text("Tenses:").bold()
//                    ForEach (0..<currentBundle.getTenseCount()){ i in
...
//            bundleNameList.append(bundle.getName())
